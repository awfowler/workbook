...
$sql = $wpdb->prepare(" SELECT v.GroupID AS group_name, v.VarietyName AS variety, COUNT(d.ID) AS total_count,
        ...
        (SELECT COUNT(*) FROM wb_varietydata d2 JOIN wb_variety v2 ON d2.Variety = v2.VarietyName WHERE v2.GroupID = %s) AS group_total,
        v.PercUKbyType,
        v.PercScotbyType,
        v.PercEWbyType
    ...
    <table border="1" cellpadding="6" cellspacing="0" style="border-collapse:collapse;width:100%;">
        ...
        <?php if (!empty($results)) : ?>
            ...
            <tr style="font-weight:bold;background:#eee;">
                ...
                <td></td>
                <td></td>
                <td><?php echo esc_html($total_group_count); ?></td>
            </tr>
        <?php else : ?>
            <tr>
